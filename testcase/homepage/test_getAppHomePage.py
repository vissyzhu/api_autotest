...
class Test_GetAppHomePage(unittest.TestCase):
    ...
    def check_result(self):
        ...
        self.assertIn('https://lyhccstatic.liangyihui.net', self.response['result']['centers'][0]['iconUrl'],
                      '单病种中心icon图标未显示')
        ...
        self.assertIn('http://bosdev.liangyihui.net', self.response['result']['teams'][0]['picUrl'], '团队头像未返回')
        ...
        self.assertIn('https://lyhccstatic.liangyihui.net', self.response['result']['doctors'][0]['portraitUrl'],
                      '医生头像未返回')
        ...
        self.assertIn('https://lyhccstatic.liangyihui.net', self.response['result']['famousHospitals'][0]['picUrl'],
                      '肿瘤名院的医院头像未返回')
        ...
        self.assertIn('http://bosdev.liangyihui.net', self.response['result']['leagues'][0]['picUrl'], '医联体头像未返回')
